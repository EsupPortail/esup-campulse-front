...
async function onGetContent() {
    try {
        await contentStore.getContentsByCode(['LEGAL_NOTICE'])
    } catch (error) {
...
const initContent = () => {
    legalNotice.value = findContentObject('LEGAL_NOTICE')
}
    ...
    <section class="dashboard-section">
        <div class="dashboard-section-container">
            <div
                ...
                v-html="DOMPurify.sanitize(legalNotice?.body)"
            >
            </div>
        </div>
    </section>
